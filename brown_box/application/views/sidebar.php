    ...
    <div class="container-fluid">
      ...
      <div class="navbar-container">
        <div id="navbarSupportedContent" class="collapse navbar-collapse">
          <ul class="navbar-nav">
            <li class="dropdown nav-item"><a id="dropdownBasic2" href="#" data-toggle="dropdown" class="nav-link position-relative dropdown-toggle"><i class="ft-bell font-medium-3 blue-grey darken-4"></i><span class="notification badge badge-pill badge-danger" id="notfication_count"></span>
            ...
            <li>
              <a onclick="cartitemsshow()" class="nav-link "><i class="ft-shopping-cart font-medium-3 blue-grey darken-4"></i>View Cart</a>
            </li>
            <?php endif ?>
